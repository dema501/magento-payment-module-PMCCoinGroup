## PMCCoinGroip payment module for Magento 1.x.
...
## Uninstall/Disable
   ...
   * From the command line edit the files: 
      * `<magento_root>/app/etc/modules/Liftmode_PMCCoinGroup.xml`
...
## Configure Magento
* The plugin is configured under **System**->**Configuration**->**Payment Methods**->**PMCCoinGroup**.
* Grab Token
* Get Team ID https://pmccoingroup.com/api/v1/teams
* Get Wallet ID https://pmccoingroup.com/api/v1/wallets
* Use CCV Verification
